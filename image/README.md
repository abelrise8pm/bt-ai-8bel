...
## Overview
This base container is designed to be shared across multiple projects. It includes pre-configured AI assistant tools (Claude Code, OpenCode) and Node.js runtime, providing a consistent development environment while maintaining security standards for CUI and Federal customers.
...
- **[OpenCode](https://github.com/anomalyco/opencode)**: Type `opencode` to get started.
